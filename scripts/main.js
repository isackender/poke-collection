    ...
    cards.each(function() {
        ...
        card.on('mouseleave', function() {
            ...
            if ($(card).hasClass("legendary")) {
                ...
                card.css('background-image', "url('./poke-collection/images/card-bg.png')");
                card.css('background-image', "url('./poke-collection/images/card-bg.png'), linear-gradient(135deg, #d0b854, #e85d00)");
            }
            ...
            if ($(card).hasClass("mythical")) {
                ...
                card.css('background-image', "url('../poke-collection/images/card-bg.png')");
                card.css('background-image', "url('../poke-collection/images/card-bg.png'), linear-gradient(135deg, rgba(119,146,187,1) 0%, rgb(62, 168, 136) 50%, rgba(54,47,90,1) 100%)");
            }
